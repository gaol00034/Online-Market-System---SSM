...
<div class="panel admin-panel">
    <div class="panel-head" id="add">
        <strong><span class="icon-pencil-square-o">添加订单中商品</span> </strong>
    </div>
    <div class="body-content">
        <form action="${ctx}/orderDetail/exAdd" method="post" class="form-x" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="label"><label>购买数量：</label></div>
                <div class="field">
                    <input type="text" class="input w50" name="num" data-validate="required:请输入数量" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
