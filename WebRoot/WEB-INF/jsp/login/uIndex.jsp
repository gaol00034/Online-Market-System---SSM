...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <!--<ul>
    ...
    <!--<script>
        $(function () {
            $(".example2").luara({width:"966",height:"490",interval:1000,selected:"seleted",deriction:"left"});
        });
    </script>-->
</div>
<!--折扣商品-->
