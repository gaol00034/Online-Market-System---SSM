    ...
    <form action="${ctx}/itemOrder/findBySql" id="listform" method="post">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left: 10px;">
                <li>
                    <a class="button border-main icon-plus-square-o" href="${ctx}/itemOrder/add">添加订单</a>
                </li>
                <li>
        ...
        <tr>
            ...
            <td>
                ...
                <c:if test="${data.status == 2}">
                    <a class="button border-red" href="${ctx}/itemOrder/force_sh?id=${data.id}"><span class="icon-trash-o">后台收货</span> </a>
                </c:if>
                <a class="button border-red" href="${ctx}/itemOrder/delete?id=${data.id}"><span class="icon-trash-o">删除</span> </a>
                <a class="button border-red" href="${ctx}/itemOrder/update?id=${data.id}"><span class="icon-trash-o">修改订单</span> </a>
            </td>
