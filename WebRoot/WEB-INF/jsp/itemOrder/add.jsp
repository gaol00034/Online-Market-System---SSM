...
<div class="panel admin-panel">
    <div class="panel-head" id="add">
        <strong><span class="icon-pencil-square-o">新增订单</span> </strong>
    </div>
    <div class="body-content">
        <form action="${ctx}/itemOrder/addByHand" method="post" class="form-x" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="remarks" data-validate="required:请输入备注" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
